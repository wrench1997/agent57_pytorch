...
class Learner:
    ...
    def update_network(self, minibatchs):
        ...
        in_q_weight = self.in_online_q_network.cpu().state_dict()
        ex_q_weight = self.ex_online_q_network.cpu().state_dict()
        embed_weight = self.embedding_net.cpu().state_dict()
        lifelong_weight = self.trained_lifelong_net.cpu().state_dict()
